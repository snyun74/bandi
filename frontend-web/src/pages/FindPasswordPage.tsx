...
const FindPasswordPage: React.FC = () => {
    ...
    const handleNext = () => {
        // Logic will be added later
        console.log('Next step with ID:', userId);
    };
        ...
        <div className="min-h-screen bg-white flex flex-col items-center">
            ...
            <div className="w-full max-w-md px-6 mt-4 flex flex-col items-center">
                ...
                <div className="w-full bg-white rounded-[2rem] p-8 shadow-[0_0_20px_rgba(0,0,0,0.03)] border border-gray-100">
                    <h2 className="text-xl font-bold text-slate-800 mb-8">비밀번호 찾기</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        {/* User ID */}
                        <div className="space-y-2">
                            <label className="block text-sm font-medium text-slate-800">아이디</label>
                            <div className="relative">
                                <input
                                    type="text"
                                    value={userId}
                                    onChange={(e) => setUserId(e.target.value)}
                                    className="w-full pl-4 pr-4 py-3.5 bg-[#f4f6f8] border border-transparent rounded-xl text-sm focus:bg-white focus:border-[#00B2FF] focus:ring-1 focus:ring-[#00B2FF] outline-none text-slate-700 placeholder-slate-400"
